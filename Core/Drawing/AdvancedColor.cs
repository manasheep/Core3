    ...
    public class AdvancedColor
    {
        ...
        public static Color GetColorFromHSB(byte A, float H, float S, float B)
        {
            ...
            else
            {
                ...
                switch (i)
                {
                    case 0: r = (byte)(B * 255); g = (byte)(t * 255); b = (byte)(p * 255);
                        break;
                    case 1: r = (byte)(q * 255); g = (byte)(B * 255); b = (byte)(p * 255);
                        break;
                    case 2: r = (byte)(p * 255); g = (byte)(B * 255); b = (byte)(t * 255);
                        break;
                    case 3: r = (byte)(p * 255); g = (byte)(q * 255); b = (byte)(B * 255);
                        break;
                    case 4: r = (byte)(t * 255); g = (byte)(p * 255); b = (byte)(B * 255);
                        break;
                    case 5: r = (byte)(B * 255); g = (byte)(p * 255); b = (byte)(q * 255);
                        break;
                }
            }
